 ...
 * @package: cn.doitedu.flink.day05
 * @className: D5_KeyedEventTimeTumblingWindowDemo1
 * @author: Cypress_Xiao
 * @description:
 * 按eventTime划分滚动窗口,即数据携带的时间;先keyBy,再划分滚动窗口;需要自己实现一个方法提取数据中的时间字段,
 * 并转成统一的格式(long类型的timestamp)
 *
 * @date: 2022/8/30 11:49
 * @version: 1.0
 */

public class D5_KeyedEventTimeTumblingWindowDemo1 {
