 ...
 * @package: cn.doitedu.flink.day10
 * @className: D05_MySQLAsyncFunction
 * @author: Cypress_Xiao
 * @description: TODO
 * @date: 2022/9/6 21:48
 * @version: 1.0
...
public class D05_MySQLAsyncFunction extends RichAsyncFunction<String, Tuple2<String, String>> {

    private transient DruidDataSource dataSource;
    private transient ExecutorService executorService;
    private int maxConnTotal; //不能加transient

    public D05_MySQLAsyncFunction(int maxConnTotal) {
