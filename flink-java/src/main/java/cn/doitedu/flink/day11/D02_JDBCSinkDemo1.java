...
public class D02_JDBCSinkDemo1 {
    public static void main(String[] args) throws Exception {
        ...
        env.getCheckpointConfig().setCheckpointStorage("file:///Users/start/Desktop/dev/flink-in-action/chk");
        ...
        SinkFunction<Tuple3<Long, String, Integer>> mysqlSink = JdbcSink.sink(
                ...
                new JdbcConnectionOptions.JdbcConnectionOptionsBuilder()
                        .withUrl("jdbc:mysql://localhost:3306/doit32?characterEncoding=utf-8")
