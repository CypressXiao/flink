 ...
 * @package: cn.doitedu.flink.day12
 * @className: D06_SqlEventTimeSlidingWindowDemo1
 * @author: Cypress_Xiao
 * @description: 使用eventTime划分滑动窗口
 * @date: 2022/9/9 15:44
 * @version: 1.0
 */

public class D07_SqlEventTimeSlidingWindowDemo1 {
    public static void main(String[] args) throws Exception {
        ...
        //使用FlinkSQL实现滑动窗口
        //HOP(e_time,INTERVAL '10' seconds)按照指定的时间段划分窗口,并指定窗口类型和窗口步长,窗口的长度
        TableResult tableResult = tEnv.executeSql("select aid,eid,count(*) as counts,hop_start(e_time,INTERVAL '5' SECONDS,INTERVAL '10' SECONDS) as win_start,hop_end(e_time,INTERVAL '5' SECONDS,INTERVAL '10' SECONDS) as win_end from v_aid_log group by HOP(e_time,INTERVAL '5' SECONDS,INTERVAL '10' SECONDS),aid,eid");
